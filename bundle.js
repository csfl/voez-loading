...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoadingIcon = __webpack_require__(168);

	var _LoadingIcon2 = _interopRequireDefault(_LoadingIcon);

	var _LoadingText = __webpack_require__(169);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('div', { className: 'bgi-glass' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'voez-load-container' },
	                    _react2.default.createElement('div', { className: 'opacity' })
	                ),
	                _react2.default.createElement(_LoadingIcon2.default, { className: 'loading-icon-main', style: {
	                        position: 'absolute',
	                        top: -10,
	                        left: 6,
	                        zIndex: 10
	                    } }),
	                _react2.default.createElement(_LoadingText2.default, {
	                    text: 'Loading...',
	                    position: 'absolute',
	                    top: 220,
	                    left: 3,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingIcon = function (_Component) {
	    ...
	    function LoadingIcon(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LoadingIcon).call(this, props));
	    }
	    ...
	    _createClass(LoadingIcon, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('div', { className: 'block block-one' }),
	                _react2.default.createElement('div', { className: 'block block-two' }),
	                _react2.default.createElement('div', { className: 'block block-three' }),
	                _react2.default.createElement('div', { className: 'block block-four' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingText = function (_Component) {
	    _inherits(LoadingText, _Component);

	    function LoadingText(props) {
	        _classCallCheck(this, LoadingText);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LoadingText).call(this, props));

	        _this.state = {
	            text: _this.props.text,
	            dropText: _this.props.text.split('').map(function (item) {
	                return {
	                    html: item,
	                    className: 'drop',
	                    style: {}
	        ...
	        _this.divStyle = {
	            position: _this.props.position ? _this.props.position : 'relative',
	            ...
	            zIndex: _this.props.zIndex ? _this.props.zIndex : 0,
	            margin: 'auto',
	            textAlign: 'center',
	            fontSize: _this.props.fontSize ? _this.props.fontSize : 20,
	            color: _this.props.color ? _this.props.color : '#fff'
	        };
	    ...
	    _createClass(LoadingText, [{
	        ...
	        key: 'clearDropTextStyle',
	        value: function clearDropTextStyle() {
	            setTimeout(function () {
	                var source = this.state.dropText;
	        ...
	        key: 'getEmptyCount',
	        value: function getEmptyCount(content) {
	            var count = 0;
	            content.split('').map(function (item) {
	                if (item.trim() == '') count++;
	            });
	            return count;
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'loading-text', style: this.divStyle },
	                _react2.default.createElement(
	                    'div',
	                    { style: this.genStyle },
	                    this.state.dropText.map(function (item, idx) {
	                        return _react2.default.createElement(
	                            'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./../../node_modules/.npminstall/sass-loader/3.2.1/sass-loader/index.js!./main.scss", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./../../node_modules/.npminstall/sass-loader/3.2.1/sass-loader/index.js!./main.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "HallFeticaVoez-87ec549365ffde1130230ec9a92f0c50.ttf";
